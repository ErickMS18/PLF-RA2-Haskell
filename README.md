...
![iniciando o programa sem arquivos](teste1.1.png)
...
![adicionando um item com 10 uniddades](teste2.1.png)

### Passo 2: Tentar remover 15 unidades desse item.
![tentativa de remover 15 unidades do item](teste2.2.png)

### Passo 3: Verificar se o programa exibiu uma mensagem de erro clara.
![exibição da mensagem de erro clara](teste2.3.png)

### Passo 4: Verificar se o Inventario.dat (e o estado em memória) ainda mostra 10 unidades.
![comando listar mostrando 10 unidades](teste2.4.2.png)
![Inventario.dat mostrando 10 unidades](teste2.4.png)

### Passo 5: Verificar se o Auditoria.log contém uma LogEntry com StatusLog (Falha ...).
![Auditoria.log com uma LogEntry com StatusLog Falha](teste2.5.1.png)
![Auditoria.log com uma LogEntry com StatusLog Falha](teste2.5.2.png)
...
![entrada de log referente à falha registrada no cenario 2](teste3.2.png)
